...
4. The Media and HTML folder names must be the same name as the ones contained within the GitHub FAQ folder for your application and mine are media and html so I will not have to change them
